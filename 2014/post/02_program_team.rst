...
オープンスペースは参加者が自由的に利用できる場所です。具体的には、参加者は小さな発表と議論などがしたい場合、その時場所と時間を提供しております。
...
事前に受付用紙とホワイトボードを準備して、当日希望者は先着順でボードの空いている枠に記入してから部屋を利用できます。さらに、もっと参加者を募集したいため、コンファレンスでアナウンスをしただけではなく、同時にTwitterで告知をしました。
...
当日オープンスペースの利用者は多いし、雰囲気もいいと思ういました。基本的に最初の考えた役に立っていました。
