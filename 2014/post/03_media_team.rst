...
.. note::
   ...
   メディアチーム全体について説明。どんなことやったかとか、詳細に触れない部分をここでフォローする。(筒井)
...
しましたが、今年のウェブサイトは DjangoのSymposionベースのウェブサイトに
しました。

理由はいくつかありますが、主な理由は自動化です。今までは、CFPや、スポンサーの
やりとりを全部メールベースで行って、かなり大変でした。今年に、CFPとスポンサーのやりとりを
サイト上で行うことで、作業を楽にするのが主な目的でした。第２目的はこれからの資産として、
...
アメリカのサイトは PyCon JP に必要な機能が揃えてませんでした。PyCon JPに必要だったのは主に多言語化
の対応でした。開発しないといけないものとして、サイトの完全国際化 (i18n), CFPの多言語化、
スポンサー情報の多言語化をリストアップしました。それぞれの対応を外注して、
村岡祐介(@jbking)さんにお願いすることにしました。

この対応は4月まで少し時間かかりますが、開発している間に参加者、スタッフ、スポンサーシップに興味ある方など、
最低限の情報を提供し、連洛を受けたいというニーズがありました。開発している間に
簡単な静的ページ(ランディングページ)と連洛窓口を用意して、1月から、4月に運用することにしました。
もともとのスケジュールだと4月の頭にランディングページを止め、新しいサイトの公開する予定でしたが、
特に私の手遅れで、スケジュールが延び、4月の下旬に公開しました。

.. よかったこと

このサイトがあったことで、いろな影響がありました。CFPや、スポンサーのやりとりはサイトの
上で行うことができて、とても楽に質の高い対応ができました。サイトのCFPのレビュー機能があり、
みんなでレビューをすることで、よりいい発表を選ぶことができた気がします。そして、
スポンサーさんはスポンサー用のロゴ、説明の文章を自分で入力・管理することができて、
いい感じにスポンサーの受け入れができたと思います。

.. 反省点

ですが、サイトの目的について、成功した部分があったら、失敗した部分もあります。サイトの構築や、
修正がやっぱり、大変でした。もともとの PyCon US のウェブサイトをフォークしたのですが、
もともと PyCon USの人たちは Symposion を自分たちのカンファレンスのために、いっぱい拡張している状況でした。
そして、力をいれて、毎年修正して、その年のカンファレンスのニーズに合わせて、開発していたから、
その書いたコードを継続的に使うなど、そういう目的があまり強くなかったです。そのため、適当に動くコードがいっぱい
あって、バグ修正などが必要でした。そして、PyCon JP の国際化のための翻訳対応、多言語のCFP対応などなどが
必要でした。我々も、スタッフの人数、スキル、時間が限られているので、長く継続的に使っていくレベルのコードが
書けませんでした。
